  ...
  static async listarTodos() {
    ...
    const [rows] = await pool.query(
      `SELECT
        ...
        ps.frequencia,
        ps.observacoes,
        ps.data_fim                  AS suplementacao_data_fim,
        ...
        pv.produto                   AS vacinacao_produto,
        pv.partida,
        pv.fabricacao,
        pv.lote,
        pv.dose                      AS vacinacao_dose,
        pv.data_inicio,
        pv.data_validade,
        pv.descricao                 AS vacinacao_descricao,
        pv.data_fim                  AS vacinacao_data_fim,
